...
drawLSystemHS :: Bool -> LSystem -> Int -> Colour -> Float -> IO ()
drawLSystemHS liveAction system n colour shift =
  drawLines liveAction (traceHS (expandLSystem system n) (angle system) colour shift)